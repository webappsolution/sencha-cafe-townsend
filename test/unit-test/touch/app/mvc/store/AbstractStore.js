...
//            expect(typeof FlowMVC.mvc.store.AbstractStore.getUsersUrl()).toEqual("string");
//        });
//
//        it("should correctly encode the event ID", function() {
//            var regExp = /event_id=12345/g;
//            var eventId = 12345;
//            var url = FlowMVC.mvc.store.AbstractStore.getUsersUrl(eventId);
//
...
//
//        it("should be a function", function() {
//            expect(typeof FlowMVC.mvc.store.AbstractStore.getPastEventsUrl).toEqual("function");
//        });
//
//        it("should return a string", function() {
//            expect(typeof FlowMVC.mvc.store.AbstractStore.getPastEventsUrl()).toEqual("string");
//        });
//
//    });
//
...
//
//        it("should be a function", function() {
//            expect(typeof FlowMVC.mvc.store.AbstractStore.getUpcomingEventsUrl).toEqual("function");
//        });
//
//        it("should return a string", function() {
//            expect(typeof FlowMVC.mvc.store.AbstractStore.getUpcomingEventsUrl()).toEqual("string");
//        });
//
//    });
