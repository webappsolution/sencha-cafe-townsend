...
Ext.define("SenchaExtensions.mvc.event.AbstractEvent", {
    ...
    statics: {
         ...
         */
        logger: SenchaExtensions.logger.Logger.getLogger("SenchaExtensions.mvc.event.AbstractEvent")
    },
    ...
    constructor: function(type) {
        ...
        SenchaExtensions.mvc.event.AbstractEvent.logger.debug("AbstractEvent.Constructor: type = ", type);
        this.type = type;
    }
})