 ...
 *
 * var responder = Ext.create("SenchaExtensions.mvc.service.rpc.Responder", this.logoutSuccess, this.logoutFailure, this);
...
Ext.define("SenchaExtensions.mvc.service.AbstractService", {
    ...
    statics: {
        ...
        NO_RESPONDER_DEFINED:
            ...
            "var responder = Ext.create('SenchaExtensions.mvc.service.rpc.Responder', this.myCustomSuccess, this.myCustomFailure, this);\n" +
            "service.setResponder(responder);\n" +
            "or\n" +
    ...
    config: {
        ...
        /**
         * @cfg {SenchaExtensions.mvc.service.rpc.Responder} responder The responder object for this service contains
